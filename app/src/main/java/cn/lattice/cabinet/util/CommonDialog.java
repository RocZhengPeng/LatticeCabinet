...
public class CommonDialog extends Dialog {
    ...
    public static class Builder {
        ...
        public Builder setPositiveButton(CharSequence text, int textColor, DKCallBackBoolean dkCallBack) {
        ...
        public Builder setPositiveButton(@StringRes int textId, int textColor, DKCallBackBoolean dkCallBack) {
        ...
        public Builder setNegativeButton(CharSequence text, int textColor, DKCallBackBoolean dkCallBack) {
        ...
        public Builder setNegativeButton(@StringRes int textId, int textColor, DKCallBackBoolean dkCallBack) {
