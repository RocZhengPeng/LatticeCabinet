...
public class DisplayHelper {
   ...
   /* public static int sp2px(int sp){
        return  (int) TypedValue.applyDimension(
                TypedValue.COMPLEX_UNIT_SP,sp, DankalApplication.getContext().getResources().getDisplayMetrics());
    }*/

    public static int sp2px( float spValue) {
        final float fontScale = RocApplication.getContext().getResources().getDisplayMetrics().scaledDensity;
