package cn.lattice.cabinet.widget.statubar;
...
public class QMUIStatusBarHelper {
    ...
    public static void translucent(Activity activity) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT_WATCH) {
            View title = activity.findViewById(R.id.dk_title);
            if (title !=null){
                title.setPadding(0, QMUIStatusBarHelper.getStatusbarHeight(activity), 0, 0);
            }
        }
    }
